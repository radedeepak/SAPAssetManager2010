        ...
        'Operations/SubOperations/SubOperationNo'
            ...
            if (result && result.length > 0) {
                ...
                if (out && out.length > 0) {
                    ...
                    return '$filter=' + out.join(' or ') + '&$expand=WorkOrderTool,FunctionalLocation&$orderby=FunctionalLocation/FuncLocId,EquipId,SortField';
                } else {
                    return '';
                }
            }  
...
export default function MeasuringPointFDCEntitySet(context) {
    ...
    if (libCommon.isDefined(pageProxy.binding)) {
        ...
        switch (odataType) {
            ...
            case operation:
                return "$filter=(PRTCategory eq 'P')&$expand=PRTPoint/MeasurementDocs,PRTPoint/MeasurementDocs/MeasuringPoint,WOOperation_Nav,WOOperation_Nav/WOHeader&$orderby=PRTPoint/SortField&$select=PRTPoint/Point,PRTPoint/PointDesc,PRTPoint/UoM,PRTPoint/RangeUOM," +
            ...
            case floc:
                return '$expand=FunctionalLocation&$orderby=SortField';
            default:
                return '';
        }
    }
