    ...
    static equipmentDetailViewFormat(context) {
        ...
        switch (section) {
            case 'EquipmentObjectHeaderSection':
                ...
                break;
            case 'EquipmentLocationSection':
                switch (property) {
                    case 'Title':
                        //Display equipment plant number with plant description and the Work Center number.
                        value = equipmentLib.getPlantAndWorkCenterDescString(context);
                        break;
                    case 'Footnote':
                        value = context.localizeText('status')+ ': ' + equipmentLib.getStatusDescription(context, true);
                        break;
                    default:
                        break;
                }
