...
export default function BOMCreateUpdateOnPageLoad(context) {
    ...
    let plant = context.evaluateTargetPath('#Control:PlantLstPkr').getValue()[0].ReturnValue;
    let slocValue = context.evaluateTargetPath('#Control:StorageLocationLstPkr').getValue()[0].ReturnValue;
    let materialNumber = context.evaluateTargetPath('#Control:MaterialLstPkr').getValue()[0].ReturnValue;
