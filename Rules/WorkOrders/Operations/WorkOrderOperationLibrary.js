...
export class OperationConstants {
    static get FromWOrkOrderOperationListQueryOptions() {
        return ''
        + '$expand=WOObjectList_Nav,Tools,OperationMobileStatus_Nav,OperationLongText,WOHeader,UserTimeEntry_Nav'
        + '&$orderby=OrderId,OperationNo,OperationMobileStatus_Nav/MobileStatus';
    }

    static get OperationListQueryOptions() {
        return ''
        + '&$expand=WOObjectList_Nav,Tools,OperationMobileStatus_Nav,OperationLongText,WOHeader,WOHeader/OrderMobileStatus_Nav,WOHeader/UserTimeEntry_Nav,UserTimeEntry_Nav'
