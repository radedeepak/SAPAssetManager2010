...
export class WorkOrderLibrary {
    ...
    */
    ...
    static getWorkOrdersListViewQueryOptions() {
        ...
        + '$expand=WODocuments,WODocuments/Document,OrderMobileStatus_Nav,Operations,Operations/SubOperations,WOPriority,MarkedJob,UserTimeEntry_Nav&'
    ...
    static getHighPriorityWorkOrdersQueryOptions() {
        ...
        + '&$expand=WODocuments,WODocuments/Document,OrderMobileStatus_Nav,Operations,Operations/SubOperations,WOPriority,MarkedJob,WOGeometries,WOGeometries/Geometry,HeaderLongText,UserTimeEntry_Nav&'
        + '$orderby=Priority,DueDate,OrderId';
    }

    static getWorkOrderDetailsNavQueryOption() {
        return '$select=NotificationNumber,CostCenter,OrderId,Priority,OrderDescription,ObjectKey,OrderType,DueDate,MainWorkCenter,MainWorkCenterPlant,PlanningPlant,ControllingArea,MaintenancePlant,FunctionalLocation/FuncLocDesc,OrderMobileStatus_Nav/MobileStatus,OrderMobileStatus_Nav/CreateUserGUID,OrderMobileStatus_Nav/ObjectKey,HeaderEquipment,HeaderFunctionLocation,MarkedJob&$expand=WODocuments,OrderMobileStatus_Nav,FunctionalLocation,Operations,Operations/SubOperations,WOGeometries/Geometry,MarkedJob,Confirmations,UserTimeEntry_Nav,WOObjectList_Nav';
    }
